...
class BookDeform:
    ...
    def __init__(self, width: int, height: int, alpha: float, beta: float):
        ...
        self.xx_deformed, self.yy_deformed, self.zz_deformed, self.xx_scaled = (
    ...
    def generate_bspline(
        self, num_alpha: float, num_beta: float, xvals: np.ndarray
    ) -> np.ndarray:
        """
    ...
    def deform_page(
        self, xx: np.ndarray, yy: np.ndarray, alpha: float, beta: float
    ) -> Tuple[np.ndarray, np.ndarray, np.ndarray]:
        """
    ...
    def project_image_on_surface(self, image_to_distord: np.ndarray) -> np.ndarray:
        """
